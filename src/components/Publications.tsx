...
const publications: Publication[] = [
  {
    title:
      'M. Agrawal, P. Mehrotra et al, "GANTouch: An Attack-Resiliyesnt Framework for Touch-Based Continuous Authentication System,"',
    venue: "IEEE Transactions on Biometrics, Behavior, and Identity Science",
    year: "Oct. 2022",
  },
  {
    title:
      'M. Agrawal, P. Mehrotra et al, "Defending Touch-based Continuous Authentication Systems from Active Adversaries Using Generative Adversarial Networks,"',
